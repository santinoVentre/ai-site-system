"""Structured logging configuration (JSON via loguru) for agent-api."""
...
class _InterceptHandler(logging.Handler):
    """Route stdlib logging records to loguru so everything shares one sink."""
...
def configure_logging(
    ...
    *,
    ...
    """Install a unified logging pipeline.

    * Routes all stdlib loggers through loguru.
    * Emits JSON lines when ``json_logs`` (or ``LOG_JSON`` env) is truthy.
    """
